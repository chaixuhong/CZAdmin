    ...
    <div v-if="show">
      <el-card class="box-card">
        <div style="color: #666;font-size: 13px;">
          ...
          <span>
            项目启动时间：{{ data.sys.startTime }}
          </span>
          <span>JDK-{{ data.jvm.version }}</span>
      ...
      <el-card class="box-card">
        ...
        <div>
          <el-col :xs="24" :sm="8" :md="4" :lg="4" :xl="4" style="margin-bottom: 10px">
          ...
          <el-col :xs="24" :sm="8" :md="5" :lg="5" :xl="5" style="margin-bottom: 10px">
          ...
          <el-col :xs="24" :sm="8" :md="6" :lg="6" :xl="6" style="margin-bottom: 10px">
