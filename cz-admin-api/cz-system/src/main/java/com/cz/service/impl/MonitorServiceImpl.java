...
import com.cz.utils.StringUtils;
...
public class MonitorServiceImpl implements IMonitorService {
    ...
    private Map<String,Object> getDiskInfo(OperatingSystem os) {
        ...
        diskInfo.put("total", total > 0 ? FormatUtil.formatBytes(total) : "?");
    ...
    private Map<String,Object> getSystemInfo(OperatingSystem os){
        ...
        systemInfo.put("startTime", DateUtil.formatDateTime(date));
        return systemInfo;
    }
    ...
    private Map<String,Object> getJvmInfo() {
        ...
        jvm.put("total", FormatUtil.formatBytes(total));
        jvm.put("max", FormatUtil.formatBytes((Runtime.getRuntime().maxMemory())));
        jvm.put("free", FormatUtil.formatBytes(free));
        jvm.put("used", FormatUtil.formatBytes(used));
        jvm.put("usageRate", df.format(used/(double)total * 100));
